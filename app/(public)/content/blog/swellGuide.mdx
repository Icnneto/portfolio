...
tags: ["solutions", "architecture", "programming"]
---
...
This decoupling means each component has a single responsibility. The spot publisher doesn't know about weather APIs. The campaign processor doesn't care where spot data came from. This separation allows any piece to evolve independently.
...
The core problem wasn't "add AI to sound modern." It was: *how do you transform technical weather JSON into natural-language insights without manually writing hundreds of conditional rules? "*
...
```
c8e96af refact: ajustar o prompt para eliminar redundâncias
41fb010 fix: corrigir o nome da variável das condições
8f55009 refact: new prompt with tide instructions
0a616f5 refact: aprimoramento do LLM e aumento dos parâmetros
```
...
SwellGuide started as a personal project to solve my own problem: understanding when and where to surf. Today it delivers daily bulletins to 50+ surfers across Florianópolis.
